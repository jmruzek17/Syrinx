...
#' Title https://www.rdocumentation.org/packages/GenABEL/versions/1.8-0/topics/rntransform
#'
#' @param formula GLM formula for the variable to be transformed, or just the variable
#' @param data data.frame or gwaa.data object containing the data
